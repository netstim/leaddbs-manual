...
5. The atlas fit and results of the normalization can be manually edited. For a thorough tutorial on how to, follow the instructions [here](https://github.com/netstim/SlicerNetstim/tree/master/WarpDrive).
